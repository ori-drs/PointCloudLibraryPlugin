...
function(wrap_python library_name sources)
  ...
  #install(TARGETS ${library_name}Python DESTINATION lib/python${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR}/site-packages)
  install(TARGETS ${library_name}Python DESTINATION lib/python${PYTHON_VERSION_MAJOR}/dist-packages)
  #install(TARGETS ${library_name}PythonD DESTINATION lib/python${PYTHON_VERSION_MAJOR}/dist-packages)
